...
public class AdapterSpinnerMaSach extends BaseAdapter {
    private Context context;
    private ArrayList<SachMode> list;

    public AdapterSpinnerMaSach(Context context, ArrayList<SachMode> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // điền dữ liệu
       txtName.setText(list.get(position).getTenSach());
        return convertView;
    }
}
