...
public class AdapterSpinnerMaTT extends BaseAdapter {
    private Context context;
    private ArrayList<ThuThuMode> list;

    public AdapterSpinnerMaTT(Context context, ArrayList<ThuThuMode> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // điền dữ liệu
       txtName.setText(list.get(position).getHoTenTT());
        return convertView;
    }
}
