...
public class AdapterSpinnerMaTV extends BaseAdapter {
    private Context context;
    private ArrayList<ThanhVienMode> list;

    public AdapterSpinnerMaTV(Context context, ArrayList<ThanhVienMode> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // điền dữ liệu
       txtName.setText(list.get(position).getNameTV());
        return convertView;
    }
}
